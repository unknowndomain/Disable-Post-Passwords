...
Tags: disable, post, passwords, post password, post visibility, multisite, network, visibility
...
[Thomas Hawk]: http://www.flickr.com/photos/thomashawk/5318245724/
...
1. You will find the `Post Passwords` panel under the `Settings` menu in the WordPress Admin.
...
1. Go to the `Settings` menu and click `Post Passwords`. 
